...
skucode = "3897042"
skuandsize = "3897042%3A9.5"
#jQuery1720123107630247855558991_1397536250233
link = "https://secure-store.nike.com/us/services/jcartService?callback=nike_Cart_hanleJCartResponse&action=" + matchObj.group(1) + "&lang_locale=" + matchObj.group(2) + "&country=" + matchObj.group(3) + "&catalogId=" + matchObj.group(4) + "&productId=" + matchObj.group(5) + "&price=" + matchObj.group(6) + "&siteId=null&line1=" + matchObj.group(7) + "&line2=" + matchObj.group(8) + "&passcode=null&sizeType=null&skuAndSize=" + skuandsize + "&qty=1&rt=json&view=3&skuId=" + skucode + "&displaySize=9.5&_=1397536308748"

link =link.replace(' ','+')
link = link.replace('&#x27;', '%27')
#print link
s = requests.post("https://www.nike.com/profile/login?Content-Locale=en_US", headers=headers, params=payload)
print s.content
print "XXXXXXXXXXXXXXXXXXXX"
print " "

t = requests.post(link, headers=headers, cookies=cookie)
print t.content
